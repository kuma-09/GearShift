...
// メッシュとRayとの衝突判定
//-----------------------------------------------------
bool CollisionMesh::IntersectRay(
...
// Obj形式のファイルをロードする
//-----------------------------------------------------
void CollisionMesh::LoadObjFile(const std::wstring& objName)
{
	// Obj形式のファイルを開く
...
//-----------------------------------------------------
void CollisionMesh::AddTriangle(
...
// 衝突したポリゴンの頂点情報を返す
//-----------------------------------------------------
std::vector<DirectX::SimpleMath::Vector3> CollisionMesh::GetHitPolygon(unsigned int hitPolygonNo)
{
