...
///	インプットレイアウト
///	</summary>
const std::vector<D3D11_INPUT_ELEMENT_DESC> BulletGage::INPUT_LAYOUT =
{
	{ "POSITION",	0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD",	0, DXGI_FORMAT_R32G32_FLOAT, 0, sizeof(DirectX::SimpleMath::Vector3) + sizeof(DirectX::SimpleMath::Vector4), D3D11_INPUT_PER_VERTEX_DATA, 0 },
};

BulletGage::BulletGage()
{
	m_boostPoint = 100;
	m_maxBoostPoint = 100;
}
...
void BulletGage::Update()
{
}

void BulletGage::Render()
{
	...
	ConstBuffer cbuff;
	cbuff.rotate = DirectX::XMConvertToRadians(90) - DirectX::XMConvertToRadians(90 * (float(m_boostPoint) / float(m_maxBoostPoint)));
