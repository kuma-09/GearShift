...
void TitleScene::Render()
{
    ...
    *static_cast<ConstantBuffer*>(mappedResource.pData) = cbuffer;
    ...
    Matrix world = Matrix::CreateTranslation(Vector3{ 0,1,3 });

    Resources::GetInstance()->GetlArmModel()->Draw(context, *state, world, view, proj, false, [&]()
        {
            //	インプットレイアウトの登録
    ...
    world = Matrix::CreateTranslation(Vector3{ 0,1,0 });
    ...
    world = Matrix::CreateTranslation(0, 1, 3);
